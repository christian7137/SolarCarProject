/***************************************************************************
  ...
  *
  * \brief 	This code is provided at the following location
			https://github.com/adafruit/Adafruit_BNO055
			
	\details The code has been modified to adopt to the acquisition classes
 ***************************************************************************/
...
void Adafruit_BNO055::readSensor(char* pData){	
 ...
 int Adafruit_BNO055::getSizeOfData(){
 	//at the moment, we will be sampling just the accelerometer data
 	//DATA: int16_t x,y,z -> 6 bytes of data
 	return 6;
 }
/**************************************************************************/
/*!
