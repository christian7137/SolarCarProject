/***************************************************************************
  ...
  * \brief 	This base code is provided at the following location
...
class Adafruit_BNO055 : public svtSensor
{
  private:
    typedef enum
    {
  ...
  public:
    Adafruit_BNO055( int sensorID, uint8_t address, int periodMs, PinName sda, PinName scl);
